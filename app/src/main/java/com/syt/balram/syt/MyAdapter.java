...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>  {
    ...
    public void onBindViewHolder(MyAdapter.ViewHolder holder, int position) {
        if (holder.Holderid == 1) {                              // as the list view is going to be called after the header view so we decrement the
           ...
           // String image_url = "https://www.sellyourtime.in/dashboard/images/"+profilePic;
            profilePic=profilePic.replace("\\","");

            String checkFB=profilePic.substring(7,12);
            System.out.println("CHECKFB------->" + checkFB);

            if(checkFB.equalsIgnoreCase("graph"))
            {
                System.out.println("FB WALI------->");
                try {
                    System.out.println("FB WALI PIC------->"+profilePic);
                   /* URL imageURL = new URL(profilePic);
                    ...
                    HttpGet httpRequest = new HttpGet(URI.create(profilePic) );
                    ...
                    holder.profile.setImageBitmap(bmap);
            ...
            else
            {
                ...
                String image_url =profilePic;
                // ImageLoader class instance
                System.out.println("IMAGE URLLL"+image_url);
                ...
                // image - ImageView
                imgLoader.DisplayImage(image_url, loader, holder.profile);
